        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cell = table.Column<string>(type: "character varying(14)", maxLength: 14, nullable: false),
                    PictureLarge = table.Column<string>(type: "text", nullable: true),
                    PictureMedium = table.Column<string>(type: "text", nullable: true),
                    PictureThumbnail = table.Column<string>(type: "text", nullable: true),
